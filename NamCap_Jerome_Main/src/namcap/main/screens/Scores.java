...
public class Scores implements Screen {
	...
	public void show() {
		...
		Image screenScores = new Image(AssetLoader.TEXTURE_SCREEN_SCORES);
		screenScores.setSize(Gdx.graphics.getWidth(), Gdx.graphics.getHeight());

		stage.addActor(screenScores);
